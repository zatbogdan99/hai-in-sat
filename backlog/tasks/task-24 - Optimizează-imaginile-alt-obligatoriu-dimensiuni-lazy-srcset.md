...
3. **`srcset`/`sizes`** — depinde de variantele din TASK-3 (thumbnail/medium): `srcset="thumb 400w, medium 1200w"` cu `sizes` corespunzător layoutului. Dacă TASK-3 nu e încă livrat, implementează restul punctelor acum și lasă srcset-ul ca sub-punct dependent.
