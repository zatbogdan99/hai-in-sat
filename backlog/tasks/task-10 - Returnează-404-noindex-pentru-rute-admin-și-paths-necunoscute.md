...
- `src/server.ts` (SSR existent): validează path-ul și răspunde 404 înainte de a servi index.html pentru paths necunoscute (același `server.ts` e atins și de TASK-47 și TASK-4 — coordonează modificările ca să nu se calce reciproc)
