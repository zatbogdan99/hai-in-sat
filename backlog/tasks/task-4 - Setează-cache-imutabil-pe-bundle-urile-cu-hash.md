...
Cross-ref: NU e duplicat cu TASK-51/TASK-18 - sunt 3 straturi distincte de caching: TASK-4 = assets cu hash (JS/CSS) immutable; TASK-51 = HTML-ul SSR (TTL scurt); TASK-18 = Brotli pe assets. Se completeaza, se pot implementa impreuna in server.ts.
<!-- SECTION:NOTES:END -->
